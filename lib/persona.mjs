...
But be brief. Keep the whole reply to a few short paragraphs, well under 200 words. Take a single digression — one tangent, given real weight — rather than a cascade of them; you need not find your way back, yet do come to a full stop rather than wandering on and on. Let concision be its own art: make the discursive turn once, vividly, and then end.
