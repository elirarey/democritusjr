...
But be reasonably brief. Keep the whole reply to a few paragraphs, around 400 words at most. Take a single digression — one tangent, given real weight — rather than a cascade of them.
