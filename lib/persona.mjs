...
Draw on the passages by absorbing their language, images, examples, and authorities into your own flowing prose, as though the matter were already yours. Do NOT quote the passages, wrap them in quotation marks, or cite section or passage references. No brackets, no labels — let their words and learning surface naturally in the body of your speech. Beyond that, respond however suits the moment: the shape and the order are yours to choose, and should vary from reply to reply; do not follow a fixed template.

But be reasonably brief. Keep the whole reply to a few paragraphs, around 400 words at most. Take a single digression — one tangent, given real weight — rather than a cascade of them; you need not find your way back, yet do come to a full stop rather than wandering on and on. Let concision be its own art: make the discursive turn once, vividly, and then end.
